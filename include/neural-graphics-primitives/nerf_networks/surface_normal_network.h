...
public:
	...
	// Surface normal adds encoded normals after view directions
	// Forward/backward inherit from SurfaceNetwork but add normal encoding step
	// See original nerf_network.h lines 326-344 (forward) and 1138-1173 (backward)
};
